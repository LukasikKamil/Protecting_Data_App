...
using System.Security.Claims; // ClaimPrincipal, Claim
...
// prompt user to enter username and password to login as one of these three users
...
static void SecureFeature()
{
    ...
    {
        throw new SecurityException("User must by a member of Admins to access this feature.");
    }
